...
with open('reference/NB_PRONOUN_DICT.json', 'r') as filename:
    NB_PRONOUN_DICT = OrderedDict(json.load(filename))

with open('reference/MALE_PRONOUN_DICT.json', 'r') as filename:
    MALE_PRONOUN_DICT = OrderedDict(json.load(filename))

with open('reference/FEMALE_PRONOUN_DICT.json', 'r') as filename:
    FEMALE_PRONOUN_DICT = OrderedDict(json.load(filename))
...
OLD_PRONOUN_DICTIONARY = OrderedDict({
    ...
    'She' : 'They',
    'she' : 'they',
    'His' : 'Their', #In some cases should be Theirs
    'his' : 'their', #In some cases should be theirs
    'Her' : 'Their',
    'her' : 'their/them',
    'hers' : 'theirs',
